...
train_params = {
    'data': "D:\\ultralytics-main\\ultralytics\\cfg\\datasets\\phoenix.yaml",  # 数据集配置文件路径，需要自定义修改
...
if __name__ == '__main__':
    # 加载预训练的模型
    model = YOLO("ultralytics/cfg/datasets/yolo11.yaml").load("weights/yolo11x.pt")
    # 进行训练
